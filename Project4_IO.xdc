...
set_property -dict {PACKAGE_PIN R2 IOSTANDARD SSTL135} [get_ports CLK_100M_IN]
create_clock -period 10.000 -name CLK_100M_IN -waveform {0.000 5.000} -add [get_ports CLK_100M_IN]

## Switches
set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33} [get_ports output_inhibit]
...
## LEDs
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports send_data]
set_property -dict {PACKAGE_PIN F13 IOSTANDARD LVCMOS33} [get_ports take_data]
set_property -dict {PACKAGE_PIN E13 IOSTANDARD LVCMOS33} [get_ports reset_LED]
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports inhibit_LED]

## Buttons
set_property -dict {PACKAGE_PIN G15 IOSTANDARD LVCMOS33} [get_ports Master_Reset]
...
#set_property -dict {PACKAGE_PIN L13 IOSTANDARD LVCMOS33} [get_ports {Bipolar_IN}]
#set_property -dict {PACKAGE_PIN N13 IOSTANDARD LVCMOS33} [get_ports {Bipolar_OUT}]
#set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { ck_io2 }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=ck_io[2]
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports send_word_out]
...
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { Bipolar_IN }]; #IO_L16N_T2_A15_D31_14   Sch=ck_io[7]
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { Bipolar_OUT }]; #IO_L17P_T2_A14_D30_14   Sch=ck_io[8]
...
set_property -dict {PACKAGE_PIN U11 IOSTANDARD LVCMOS33} [get_ports {data_word_out[0]}]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports {data_word_out[1]}]
set_property -dict {PACKAGE_PIN R11 IOSTANDARD LVCMOS33} [get_ports {data_word_out[2]}]
set_property -dict {PACKAGE_PIN T13 IOSTANDARD LVCMOS33} [get_ports {data_word_out[3]}]
set_property -dict {PACKAGE_PIN T12 IOSTANDARD LVCMOS33} [get_ports {data_word_out[4]}]
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports {data_word_out[5]}]
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports {data_word_out[6]}]
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports {data_word_out[7]}]
set_property -dict {PACKAGE_PIN V14 IOSTANDARD LVCMOS33} [get_ports {data_word_out[8]}]
set_property -dict {PACKAGE_PIN R13 IOSTANDARD LVCMOS33} [get_ports {data_word_out[9]}]
set_property -dict {PACKAGE_PIN P13 IOSTANDARD LVCMOS33} [get_ports {data_word_out[10]}]
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports {data_word_out[11]}]
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports {data_word_out[12]}]
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports {data_word_out[13]}]
set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports {data_word_out[14]}]
set_property -dict {PACKAGE_PIN U15 IOSTANDARD LVCMOS33} [get_ports {data_word_out[15]}]
...
create_clock -period 12.500 -name VIRTUAL_clk_out80M_clk_manchester_0 -waveform {0.000 6.250}
create_clock -period 50.000 -name VIRTUAL_clk_out20M_clk_manchester_0 -waveform {0.000 25.000}

set_output_delay -clock [get_clocks VIRTUAL_clk_out20M_clk_manchester_0] -min -add_delay -6.150 [get_ports {data_word_out[*]}]
set_output_delay -clock [get_clocks VIRTUAL_clk_out20M_clk_manchester_0] -max -add_delay 12.600 [get_ports {data_word_out[*]}]
set_output_delay -clock [get_clocks VIRTUAL_clk_out20M_clk_manchester_0] -min -add_delay -6.150 [get_ports send_data]
set_output_delay -clock [get_clocks VIRTUAL_clk_out20M_clk_manchester_0] -max -add_delay 12.600 [get_ports send_data]
set_output_delay -clock [get_clocks VIRTUAL_clk_out20M_clk_manchester_0] -min -add_delay -6.150 [get_ports send_word_out]
set_output_delay -clock [get_clocks VIRTUAL_clk_out20M_clk_manchester_0] -max -add_delay 12.600 [get_ports send_word_out]
set_output_delay -clock [get_clocks VIRTUAL_clk_out20M_clk_manchester_0] -min -add_delay -6.150 [get_ports take_data]
set_output_delay -clock [get_clocks VIRTUAL_clk_out20M_clk_manchester_0] -max -add_delay 12.600 [get_ports take_data]
create_clock -period 12.500 -name virtual_clock

set_output_delay -clock [get_clocks virtual_clock] -min -add_delay 3.000 [get_ports reset_LED]
set_output_delay -clock [get_clocks virtual_clock] -max -add_delay 3.000 [get_ports reset_LED]

set_output_delay -clock [get_clocks virtual_clock] -min -add_delay 3.000 [get_ports inhibit_LED]
set_output_delay -clock [get_clocks virtual_clock] -max -add_delay 3.000 [get_ports inhibit_LED]

set_false_path -from [get_ports Master_Reset] -to [get_ports reset_LED]
set_false_path -from [get_ports output_inhibit] -to [get_ports inhibit_LED]
set_false_path -from [get_ports Master_Reset] -to [get_ports reset_LED]
set_false_path -from [get_ports Master_Reset] -to [get_ports reset_LED]
set_false_path -from [get_ports output_inhibit] -to [get_ports inhibit_LED]
...
connect_debug_port dbg_hub/clk [get_nets clk_out80M]
#connect_debug_port dbg_hub/clk [get_nets CLK_100M_IN]
